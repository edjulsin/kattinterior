...
<p align='center'>
  ...
  <br><br>
  <img src="./assets/screenshots/2.gif" alt="Katt Editor" style="width: 60%;">
</p>

The application is built with **Next.js (App Router)**, **TypeScript**, **Supabase**, **Tailwind CSS**, **Radix UI**, and **Resend**, combining a modern front-end stack with a scalable backend and a strong emphasis on performance and SEO.

🌐 Live Site: https://kattinterior.com/
...
Overall, the project focuses on delivering a production-ready, content-driven experience with strong performance, accessibility, and maintainable front-end architecture.
