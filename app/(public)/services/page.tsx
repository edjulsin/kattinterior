...
export default () => (
    <div className='flex flex-col gap-y-40'>
        <section className='grid grid-cols-[1fr_2fr] grid-rows-[1fr_auto] gap-14'>
            <Image
        ...
        <section className='text-center mx-auto max-w-lg'>
            ...
            <br />
            <br />
            <h2 className='font-serif text-xl/loose '>Authentic spaces bring comfort and ease. Every interior tells a story—it’s a reflection of you.</h2>
        </section>
        <section className='grid grid-cols-2 place-items-center gap-x-10 '>
            ...
            <div>
                ...
                <br />
                <Link className='text-xl font-sans font-semibold text-gold-950' href='/projects'>Our projects &rarr;</Link>
            </div>
        </section>
        <section className='flex justify-center items-center gap-x-20'>
            <div className='max-w-md font-sans font-semibold'>
                <p className='text-lg'>
                ...
                <br />
                <Link className='text-xl text-gold-950' href='/contact'>Contact us <span>&rarr;</span></Link>
            </div>
            <Image
        ...
        <section className='flex justify-center items-start text-center gap-x-35'>
            <div className='max-w-sm'>
                ...
                <br />
                <br />
                <Link href='/commercial-design' className='text-base font-sans font-semibold uppercase text-gold-950'>Read our code for commercial interiors</Link>
            </div>
            <div className='max-w-sm'>
                ...
                <br />
                <br />
                <Link href='/residential-design' className='font-sans text-base font-semibold uppercase text-gold-950'>See our residential packages</Link>
            </div>
        </section>
        <section className='flex flex-col place-items-center text-center gap-y-20 mx-auto'>
            ...
            <Link href='/projects' className='col-span-2 text-xl font-semibold font-sans text-gold-950'>All our projects <span>&rarr;</span></Link>
        </section>
        <Bottom />
    </div>
)