    ...
    <div className='flex flex-col gap-y-40'>
        ...
        <section className='flex justify-center items-start text-center gap-x-35'>
            <div className='max-w-sm'>
                ...
                <br />
                <br />
                <Link href='/commercial-design' className='text-base font-sans font-semibold uppercase text-amber-600'>Read our code for commercial interiors</Link>
            </div>
            <div className='max-w-sm'>
                ...
                <br />
                <br />
                <Link href='/residential-design' className='font-sans text-base font-semibold uppercase text-amber-600'>See our residential packages</Link>
            </div>
        </section>
        <section className='flex flex-col place-items-center text-center gap-y-20 mx-auto'>
            ...
            <Link href='/projects' className='col-span-2 text-xl font-semibold font-sans text-amber-600'>All our projects <span>&rarr;</span></Link>
        </section>
        <Bottom />
    </div>
)