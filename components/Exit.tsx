        ...
        <DropdownMenu.Root>
            ...
            <DropdownMenu.Portal>
                <DropdownMenu.Content
                    align='end'
                    sideOffset={10}
                    className='text-sm font-semibold font-sans rounded-lg ring-1 ring-neutral-200 *:cursor-pointer p-1 min-w-20 *:opacity-50 *:transition-opacity'
                >
                    <DropdownMenu.Item
                        onSelect={home}
                        className='flex w-full items-center px-3 py-1.5 outline-transparent outline-1 rounded-lg hover:opacity-100'
                    >
                        Home
                    </DropdownMenu.Item>
                    <DropdownMenu.Item
