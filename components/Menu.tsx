...
export default ({ className = '' }: { className?: string }) => {
    ...
    return (
        <Root onOpenChange={ onOpenChange }>
            ...
            <Portal>
                <Overlay className={ clsx('fixed inset-0 bg-[#6E3931] z-50 group', { 'overflow-y-scroll': scrollable }) }>
                    <Content className='grid size-full grid-rows-[auto_1fr_auto] text-white place-items-center max-w-7xl mx-auto gap-y-[5dvh]'>
                        <VisuallyHidden>
